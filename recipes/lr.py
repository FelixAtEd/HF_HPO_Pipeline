...
from common.utilities import setup_logging, quick_launch
...
def main():
    ...
    training_pipeline = TrainingPipeline(
        raw_dataset, training_args, model_args, data_args, hpo_args
    )

    training_pipeline.create_output_dir("lr")
    ...
    base_model = training_pipeline.get_model(
        pretrained=True, trained_checkpoint=best_model_path
    )
